...
public:
  ...
  std::vector<std::string> applyCommands(const tesseract::environment::Commands& commands) const override final;
  ...
  bool applyCommands(const std::string& monitor_namespace,
                     const tesseract::environment::Commands& commands) const override final;
  bool applyCommands(const std::string& monitor_namespace,
