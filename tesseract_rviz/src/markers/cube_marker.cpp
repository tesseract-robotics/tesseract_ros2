...
{
  shape_ = new rviz_rendering::Shape(rviz_rendering::Shape::Cube, scene_manager_, scene_node_);
  setScale(scale_);
}
...
void CubeMarker::createMarkerSelectionHandler(rviz_common::DisplayContext* context)
{
