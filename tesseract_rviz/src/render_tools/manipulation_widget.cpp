...
//  , trajectory_slider_dock_panel_(nullptr)
{
  ...
  working_frame_property_ = new rviz_common::properties::EnumProperty(
      "Working Frame", "", "The marker working frame", main_property_, SLOT(changedWorkingFrame()), this);

  tcp_frame_property_ = new rviz_common::properties::EnumProperty(
  ...
  joint_config_base_link_property_ = new rviz_common::properties::EnumProperty(
