...
bool isIdentical(const tesseract::geometry::Geometry& shape1, const tesseract::geometry::Geometry& shape2);
...
bool fromMsg(std::shared_ptr<tesseract::scene_graph::Material>& material,
             const tesseract_msgs::msg::Material& material_msg);

bool toMsg(tesseract_msgs::msg::Inertial& inertial_msg,
           const std::shared_ptr<tesseract::scene_graph::Inertial>& inertial);

bool fromMsg(std::shared_ptr<tesseract::scene_graph::Inertial>& inertial,
...
bool fromMsg(std::shared_ptr<tesseract::scene_graph::Visual>& visual,
...
std::shared_ptr<tesseract::environment::Command> fromMsg(const tesseract_msgs::msg::EnvironmentCommand& command_msg);
...
bool processMsg(
    tesseract::environment::Environment& env,
 ...
 */
tesseract_msgs::msg::ChainGroup toMsg(std::vector<tesseract::srdf::ChainGroups>::const_reference group);
 ...
 */
tesseract_msgs::msg::GroupsJointStates toMsg(std::vector<tesseract::srdf::GroupJointStates>::const_reference group);
 ...
 */
tesseract_msgs::msg::GroupsTCPs toMsg(std::vector<tesseract::srdf::GroupTCPs>::const_reference group);
 ...
 */
std::unique_ptr<tesseract::environment::Environment> fromMsg(const tesseract_msgs::msg::Environment& environment_msg);
...
/**
 * @brief Converts a tesseract::common::JointTrajectory msg to a trajectory_msgs::msg::JointTrajectory object
...
/**
 * @brief Convert trajectory_msgs::msg::JointTrajectory to Tesseract tesseract::common::JointTrajectory
